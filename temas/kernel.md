...
![https://wiki.osdev.org/images/a/aa/Monolithic.png](../img/kernel-monolithic.png "Kernel monolítico")

## Microkernel

+ <https://wiki.osdev.org/Microkernel>

![https://wiki.osdev.org/images/2/28/Microkernel.png](../img/kernel-microkernel.png "MicroKernel")
...
![https://techdifferences.com/wp-content/uploads/2016/12/Microkernel-Vs-Monolithic-Kernel.jpg](../img/Microkernel-Vs-Monolithic-Kernel.jpg "")
![https://www.youtube.com/watch?v=4RVSgxrsxvE](../img/kernel-types.jpg "")
...
![https://en.wikipedia.org/wiki/Linux_kernel](../img/Linux_kernel_diagram.png)
![https://commons.wikimedia.org/wiki/Linux_kernel](../img/Linux_kernel_map.png)
...
![https://en.wikipedia.org/wiki/Architecture_of_Windows_NT](../img/Windows_2000_architecture.svg)

### Mac OS X, macOS, iOS, iPadOS

+ <https://en.wikipedia.org/wiki/Mach_%28kernel%29>

![https://www.oreilly.com/library/view/the-mac-hackers/9781118080337/images/f0101_fmt.gif](../img/MacOSX-architecture.gif)

## Kernel space y User space

+ <https://drawings.jvns.ca/userspace/>

![https://drawings.jvns.ca/userspace/](../img/userspace.png)
